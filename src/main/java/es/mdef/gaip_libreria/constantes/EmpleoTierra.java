...
/**
 * Enumeración que representa los diferentes empleos en el Ejército de Tierra.
 */
@Getter
public enum EmpleoTierra implements Empleo {
    SOLDADO("Soldado"),
    ...
    /**
     * Constructor para asignar un nombre legible a cada empleo en el Ejército de Tierra.
     *
     * @param nombre Nombre legible del empleo.
     */
    EmpleoTierra(String nombre) {
        this.nombre = nombre;
    }
}